...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final goals   = account.activeGoals;

    return Scaffold(
      backgroundColor: bgColor,
      body: RefreshIndicator(
        onRefresh: () async {
          await context.read<AccountProvider>().fetchAccountData();
        },
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                _miniStat(
                                  'Goals',
                                  '${account.activeGoalsCount} Active',
                                  Icons.flag,
                                ),
                              ],
                            ),
