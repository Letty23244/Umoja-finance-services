      ...
      if (response["status"] == "success" ||
        ...
        if (mounted) {
          context
              ...
              .applyWithdrawal(newBalance, enteredAmount, 'Cash Pickup');
        }

        _showSuccessSheet(enteredAmount);
      } else {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content:
                  Text(response["message"] ?? "Withdraw failed")),
        );
      }
    } catch (e) {
      setState(() => _loading = false);
        ...
        const Expanded(
          child: Column(
              ...
              children: [
                ...
                SizedBox(height: 4),
                Text(
                    'Visit our nearest branch to collect your funds.',
                    style: TextStyle(
                        color: lightGreen,
                        fontSize: 11,
                        height: 1.5)),
      ...
      child: Row(
          ...
          children: [
            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Text('UGX ${_formatCurrency(_currentBalance)}',
    ...
    showModalBottomSheet(
      ...
      builder: (_) => Container(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Text(
              'UGX ${_formatCurrency(amount)} via Cash Pickup\nwill be processed within 24 hours.',
